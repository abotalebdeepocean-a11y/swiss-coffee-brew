...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 left-6 z-40 grid size-14 place-items-center rounded-full bg-[#25d366] text-white shadow-[0_10px_30px_rgba(37,211,102,0.4)] transition-transform hover:scale-105"
    >
      <span
