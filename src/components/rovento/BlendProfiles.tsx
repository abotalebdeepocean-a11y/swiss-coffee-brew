...
const PROFILES: BlendProfile[] = [
  {
    ...
    price: 890,
    story:
      "بريميوم هو الجواب لللي بيدور على نعومة بذوق كامل. أرابيكا 100% مختارة حبة حبة من كولومبيا والجواتيمالا، محمصة تحميص متوسط عشان تحافظ على حلاوتها الطبيعية وروائحها. إسبريسو ناعم يفتح يومك — أو لاتيه وكابتشينو بجودة الكافيهات.",
    tag: "ناعمة • متوازنة • فاخرة",
    notes: ["كراميل", "مكسرات محمصة", "حموضة معتدلة", "حلاوة طبيعية"],
    brewing: ["إسبريسو", "لاتيه", "كابتشينو", "فلتر — V60"],
    specs: [
      { label: "النسبة", value: "100% أرابيكا" },
      { label: "المنشأ", value: "كولومبيا · الجواتيمالا" },
      { label: "التحميص", value: "متوسط — Medium Roast" },
      { label: "الطحن", value: "حبوب كاملة" },
      { label: "الكافيين", value: "متوسط" },
  ...
  },
  {
    ...
    price: 690,
    story:
      "ولد بار إنتنسو من فكرة واحدة: إسبريسو يفرض احترامه من أول رشفة. روبوستا قوية من هضاب الهند بتدي الجسم والكريمة الكثيفة، وأرابيكا من مرتفعات الجواتيمالا بتدي العمق. البلند اللي بيخلي الكورتادو والماكياتو تجربة يومية مختلفة.",
    tag: "قوية • غنية • جريئة",
    ...
    specs: [
      ...
      { label: "التحميص", value: "غامق — Dark Roast" },
      { label: "الطحن", value: "حبوب كاملة" },
