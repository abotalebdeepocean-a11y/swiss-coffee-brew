...
const PROFILES: BlendProfile[] = [
  {
    ...
    story:
      "مش محتاج تفهم في القهوة عشان تحس بالفرق — أول رشفة هتعرفها لوحدها. بريميوم بلند متوازن: 50% أرابيكا من مرتفعات الجواتيمالا و50% روبوستا من الهند بتحميص وسط، بيدّيك نعومة وحلاوة معتدلة ولمسة نهائية طويلة. إسبريسو يفتح يومك، أو لاتيه وكابتشينو بجودة الكافيهات — من غير ما تحس إنك محتاج سكر.",
    ...
    specs: [
      { label: "النسبة", value: "50% أرابيكا / 50% روبوستا" },
  ...
  },
  {
    ...
    story:
      "بار إنتنسو اتعمل من فكرة واحدة: إسبريسو يفرض احترامه من أول رشفة. الكريمة دي مش بتتلاشى — روبوستا كولومبي فاخر بيدّي جسم كثيف وكريمة متلزمة على الوجه، وأرابيكا الجواتيمالا بتدي العمق. البلند اللي بيخلي الكورتادو والماكياتو تجربة يومية مختلفة بجد.",
      ...
      <div className="mx-auto max-w-[1100px] px-4 md:px-6">
        ...
        >
          ...
          <h2 className="mt-3 text-3xl font-black leading-snug md:text-5xl">
            ...
            <span className="text-[#f5efe6]"> — قوي ولا ناعم؟</span>
          </h2>
