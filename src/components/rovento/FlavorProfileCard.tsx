...
export const FLAVOR_PROFILES = {
  ...
  intenso: {
    ...
    metrics: [
      { en: "Body", ar: "الجسم", value: 10 },
      { en: "Crema", ar: "الكريما", value: 10 },
      { en: "Aroma", ar: "الرائحة", value: 9 },
      { en: "Sweetness", ar: "الحلاوة", value: 6 },
      { en: "Acidity", ar: "الحمضية", value: 5 },
      { en: "Bitterness", ar: "المرارة", value: 9 },
  ...
  premium: {
    ...
    metrics: [
      { en: "Body", ar: "الجسم", value: 10 },
      { en: "Crema", ar: "الكريما", value: 10 },
      { en: "Aroma", ar: "الرائحة", value: 10 },
      { en: "Sweetness", ar: "الحلاوة", value: 8 },
      { en: "Acidity", ar: "الحمضية", value: 7 },
      { en: "Bitterness", ar: "المرارة", value: 6 },
