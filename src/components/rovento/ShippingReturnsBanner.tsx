...
const ITEMS = [
  ...
  },
  {
    icon: "💳",
    title: "الدفع",
    desc: "مش محتاج تثق فينا الأول — ادفع لما يوصّلك. وكمان فودافون كاش / إنستاباي / فوري.",
  },
  {
    icon: "🔄",
    title: "الاسترجاع",
  ...
  {
    icon: "✅",
    title: "اقدر ارجع المنتج ؟ ايوة تقدر",
    desc: "لو فيه عيب أو مش مطابق للوصف — عندك 14 يوم ترجع فيه الكيس وتاخد فلوسك، ولو فيه عيب تغليف بنستبدله فورًا.",
  },
];
