...
const ITEMS = [
  ...
  },
  {
    icon: "💳",
    title: "الدفع",
    desc: "مش محتاج تثق فينا الأول — ادفع لما يوصّلك. وكمان فودافون كاش / إنستاباي / فيزا.",
  },
  {
    icon: "🔄",
    title: "الاسترجاع",
  ...
  },
  {
    icon: "✅",
    title: "مش عجبك؟ ارجعه",
    desc: "عندك 14 يوم ترجع فيه الكيس وتاخد فلوسك — ولو فيه عيب تغليف بنستبدله فورًا. خلاص.",
  },
];
