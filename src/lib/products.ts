...
export const PRODUCTS: Product[] = [
  // ====== حبوب الإسبريسو — المنتجان فقط ======
  {
    ...
    description:
      "الكريمة دي مش بتتلاشى — بتقف على الوجه لآخر رشفة. 70% روبوستا كولومبي و30% أرابيكا جواتيمالا بتحميص وسط، قوام كامل وكافيين أعلى — اتعمل أصلاً للمشروبات اللي بالحليب وللكورتادو. مش محتاج تفهم في القهوة — هتحس بالفرق من أول كوب.",
  ...
  },
  {
    ...
    description:
      "ناعمة. متوازنة. مش بتحتاج سكر. بلند 50% أرابيكا من مرتفعات الجواتيمالا و50% روبوستا من الهند بتحميص متوسط — رائحة غنية، جسم ناعم، ولمسة نهائية طويلة بتفضل معاك. إسبريسو يفتح يومك، أو لاتيه وكابتشينو بجودة الكافيهات — في بيتك.",
