...
export const PRODUCTS: Product[] = [
  {
    ...
    name: "ROVENTO بريميم بليند — حبوب إسبريسو 70% أرابيكا",
    nameEn: "ROVENTO Premium Blend", 
    category: "beans",
    price: 1200,
    weight: "1 كجم",
    variants: [
      { id: "1kg", label: "1 كجم", weight: "1 كجم", price: 1200 },
      { id: "ground", label: "مطحون إسبريسو — 1 كجم", weight: "1 كجم مطحون", price: 1200 },
    ],
    rating: 4.9,
    reviews: 214,
    badge: "الأكثر مبيعًا",
  ...
  },
  {
    ...
    name: "ROVENTO كلاسيك بليند — حبوب إسبريسو 50% أرابيكا",
    nameEn: "ROVENTO Classic Blend", 
    category: "beans",
    price: 690,
    weight: "1 كجم",
    variants: [
      { id: "1kg", label: "1 كجم", weight: "1 كجم", price: 690 },
      { id: "ground", label: "مطحون — 1 كجم", weight: "1 كجم مطحون", price: 690 },
    ],
    rating: 4.7,
    reviews: 142,
    accent: "#002fa7",
