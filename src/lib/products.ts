...
export const PRODUCTS: Product[] = [
  // ====== حبوب الإسبريسو — المنتجان فقط ======
  {
    ...
    description:
      "توليفة قوية بكافيين أعلى ومناسبة أكتر للمشروبات المعتمدة على الحليب — 70% روبوستا كولومبي و30% أرابيكا جواتيمالا. كريمة كثيفة (Rich Crema)، تحميص وسط، قوام كامل (Full Body). مثالي لعشاق الإسبريسو القوي والكورتوادو.",
  ...
  },
  {
    ...
    description:
      "نكهة غنية فاخرة — تجربة قيّمة لعشاق الإسبريسو. بلند فاخر من 50% أرابيكا (مرتفعات الجواتيمالا) و50% روبوستا (الهند)، بتحميص متوسط. رائحة غنية متوازنة، جسم ناعم (Smooth Body)، حموضة منخفضة-متوسطة، ولمسة نهائية طويلة مميزة.",
