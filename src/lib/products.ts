...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    notes: ["كريمة غنية", "عمق في النكهة", "تأثير إيطالي"],
    description:
      "نفس جودة البار انتينسو في حجم أصغر — مثالي للتجربة الأولى أو للرحلة. كريمة غنية، تحميص غامق، قوة عالية.",
    brewing: ["إسبريسو", "كورتوادو", "ماكياتو"],
    gallery: [
      IMAGES.products.barIntenso,
      IMAGES.bags.intenso,
  ...
  },
  {
    ...
    notes: ["نكهة غنية فاخرة", "كريمة غنية", "تجربة قيّمة"],
    description:
      "نفس جودة البريميوم في حجم أصغر — 100% أرابيكا بنكهة غنية وكريمة فاخرة. مثالي للتجربة الأولى.",
    brewing: ["إسبريسو", "لاتيه", "كابتشينو", "فلتر"],
    gallery: [
      IMAGES.products.premium,
      IMAGES.bags.premium,
