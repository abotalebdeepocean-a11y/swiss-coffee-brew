...
const CHARACTERS = [
  {
    ...
    desc: "النسر رمز الدقة والانتقائية. زي ما النسر بيختار مرتفعاته بعناية، بريميوم خليط متوازن — ٥٠٪ أرابيكا ٥٠٪ روبوسيتا من حبوب قهوة كولومبي و جواتيمالي و هندي — عشان يطلع إسبريسو ناعم ومتوازن بنكهة فاخرة.",
...
const SPECS = [
  {
    name: "بار إنتنسو",
    nameEn: "BAR INTENSO",
    ratio: "٣٠٪ ارابيكا / ٧٠٪ روبوسيتا",
    origin: "كولومبيا • الهند • الجواتيمالا",
    roast: "تحميص وسط",
  },
  {
    name: "بريميوم",
    nameEn: "PREMIUM",
    ratio: "٥٠٪ أرابيكا / ٥٠٪ روبوسيتا",
    origin: "كولومبيا • الجواتيمالا • الهند",
    roast: "تحميص متوسط",
  },
];
