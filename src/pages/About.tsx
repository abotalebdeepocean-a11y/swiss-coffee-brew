...
/* ═══════════ النص المعتمد — من نحن ═══════════ */
const ABOUT_TEXT = [
  "روفينتو محمصة قهوة مختصة مصرية، اتأسست بهدف واحد: إن الإسبريسو اللي يوصل لبيتك يكون بنفس جودة الإسبريسو اللي في أحسن الكافيهات.",
...
const CHARACTERS = [
  {
    ...
    desc: "النسر رمز الدقة والانتقائية. زي ما النسر بيختار مرتفعاته بعناية، بريميوم مختار من أجود حبوب الأرابيكا عشان يطلع إسبريسو ناعم ومتوازن بنكهة فاخرة.",
...
export default function About() {
  useEffect(() => {
    document.title = "من نحن | ROVENTO — محمصة قهوة مختصة";
